...
public class MainActivityWeek7 extends AppCompatActivity {
    ...
    private void showSnackBar(View view) {
        Snackbar snackbar = Snackbar
                ...
                .setAction(R.string.retry, new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(MainActivityWeek7.this,
        ...
        snackbarView.setBackgroundColor(ContextCompat.getColor(this, R.color.colorOrange));
    ...
    private void setAnimation() {
        Button button = findViewById(R.id.sample_test);
